...
```bash
# bash
tree  ./backend-page-template > structure.txt
# powershell
tree ./backend-page-template /f /a | Out-File -FilePath structure.txt -Encoding utf8
...
| `./backend-page-template/assemble`                           | 目录 | VUE 装配逻辑                            |
...
| `./backend-page-template/module/effect`                      | 目录 | **副作用/监听层**，处理非 UI 的逻辑触发 |
| `./backend-page-template/module/effect/dom.js`               | 文件 | 直接操作 DOM 的相关逻辑                 |
| `./backend-page-template/module/effect/listener.js`          | 文件 | 各种原生监听器（如 resize, scroll 等）  |
| `./backend-page-template/module/effect/mitter.js`            | 文件 | 事件总线 (Mitt) 处理                    |
| `./backend-page-template/module/effect/other.js`             | 文件 | 其他非分类副作用                        |
| `./backend-page-template/module/effect/timer.js`             | 文件 | 定时器相关逻辑管理                      |
| `./backend-page-template/module/effect/watcher.js`           | 文件 | Vue Watcher 监听逻辑                    |
| `./backend-page-template/module/lifecycle`                   | 目录 | 切面生命周期回调                        |
| `./backend-page-template/module/lifecycle/lifecycle.js`      | 文件 | 切面生命周期回调                        |
| `./backend-page-template/module/exposed-method`              | 目录 | 切面对外暴露方法                        |
| `./backend-page-template/module/exposed-method/exposed-method.js` | 文件 | 切面对外暴露方法                        |
