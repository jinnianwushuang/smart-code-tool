...
| `./backend-page-template/composable/assembler.js`            | 文件 | 聚合装配 (Assembler/All Assembly)         |
| `./backend-page-template/composable/module`                  | 目录 | 装配单元目录                              |
| `./backend-page-template/composable/module/lifecycle.js`     | 文件 | 单元调度装配 (Lifecycle Assembly)         |
| `./backend-page-template/composable/module/method.js`        | 文件 | 单元方法装配 (Method Assembly)            |
| `./backend-page-template/composable/module/state.js`         | 文件 | 单元属性装配 (State Assembly)             |
