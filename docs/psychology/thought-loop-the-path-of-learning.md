...
```mermaid
graph TD
    A[新信息/新任务] --> B[确认知识属性与信源<br/>0.前置协议]
    B --> C[调用思维工具箱进行拆解<br/>4.思维方法/3.费曼法]
    C --> D[合上书本盲写测试<br/>抓取卡壳点<br/>3.元审计/2.流利拦截]
    D --> E{遭遇挫败/<br/>不符合预期}
    E -->|是| F[启动双环复盘<br/>彻底更新底层假设<br/>6.实用补丁]
    E -->|否| G[完成学习循环]
```
