---
title: '浏览器基础与 DevTools 实战 [P4-P5]'
level: 'junior'
...
# 浏览器基础与 DevTools 实战 [P4-P5]

> 理解浏览器的基本结构和工作原理，熟练使用 Chrome DevTools，是前端工程师的基本技能。
