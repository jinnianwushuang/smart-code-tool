...
import * as all_config from 'project/pages/vue-test/multiton-demo/multiton-lv5/config/config.js'

const { categoryOptions, statusOptions, formRules } = all_config
...
onMounted(() => {
  if (props.isEdit) {
    formState.value = { ...props.editing_obj }
  }
})
</script>
