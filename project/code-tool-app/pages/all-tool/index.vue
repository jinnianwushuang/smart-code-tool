...
import { codeToolTabs, codeToolDefaultTab } from 'project/pages/code-tool/tool-registry.js'
import { commonToolTabs } from 'project/pages/common-tool/tool-registry.js'
