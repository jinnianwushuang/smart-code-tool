...
export const routes_tool = [
  {
    ...
    component: () => import('project/layout/layout-tool.vue'),
    children: [
      {
        path: 'domain-guide',
        name: 'domain-guide',
        meta: { title: '技术导航', icon: () => h(HomeOutlined) },
        component: () => import('project/pages/domain-guide/domain-guide.vue'),
      },
      {
        path: 'all-tool',
        name: 'all-tool',
        meta: { title: '所有工具', icon: () => h(FileTextOutlined) },
        component: () => import('project/pages/all-tool/index.vue'),
      },
      {
        path: 'code-tool',
        name: 'code-tool',
        meta: { title: '代码工具', icon: () => h(CodeOutlined) },
        component: () => import('project/pages/code-tool/index.vue'),
      },
      {
        path: 'common-tool',
        name: 'common-tool',
